...
links:
  github: "https://github.com/Y-Mizutani2005"
...
- **こだわったポイント:**
    - **Markdownパーサー:** MarkdownをHTMLにパースする！サムネイル画像、日時やタグ付けなどメタデータ付与もできるようにした。とにかく投稿までのハードルを低くした。**日常的な使い心地の良さ** がいいと、気分が良くて使い続けたくなると思うので、:red[私のスタンスとして開発では常にUX第一でこだわりたいです！]
...
開発中には細かくコミットを切って進めていたため、AIが数回起こした破壊的な変更に問題なく対応できました。あたりまえの事ですが、:red[こまめなコミットとテストが有効]ですね。
...
記事を書くことで、サイトと私自身を成長させていきたいです。2026年以降の私よろしくね。